...
def apply_config(con, config_dict, args):
    ...
    con.set_eta1(config_dict.get('eta1', config_dict.get('lmbda2', 0.01)))
    con.set_eta2(config_dict.get('eta2', config_dict.get('lmbda2', 0.01)))
    con.set_model_type(config_dict.get('model_type', 'entity_relation_embedding'))
    con.set_t_uni(config_dict.get('t_uni', 2.0))
    con.set_gamma_uni_ent(config_dict.get('gamma_uni_ent', 1.0))
    con.set_gamma_uni_tail(config_dict.get('gamma_uni_tail', 1.0))
    con.set_gamma_uni_head(config_dict.get('gamma_uni_head', 1.0))
    con.set_gamma_uni_query(config_dict.get('gamma_uni_query', 1.0))
    con.set_gamma_neg(config_dict.get('gamma_neg', 1.0))
    con.set_epsilon(config_dict.get('epsilon', 1e-8))
    con.set_margin(1.0)
